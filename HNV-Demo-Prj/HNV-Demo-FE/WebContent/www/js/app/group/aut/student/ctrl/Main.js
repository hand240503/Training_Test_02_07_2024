define([
        ...
        'text!group/aut/student/tmpl/Main.html',
        
        'group/aut/student/ctrl/List',
        'group/aut/student/ctrl/Ent'      
	...
	var CtrlMain 	= function (header, content, footer, grpName) {
		...
		var pr_grpPath				= 'group/aut/student';
		...
		this.do_lc_show_callback = function(){
			try { 
				...
				console.log(e);
				do_gl_exception_send(App.path.BASE_URL_API_PUBL,  "aut.user", "Main", "do_lc_show", e.toString()) ;
			}
		};
